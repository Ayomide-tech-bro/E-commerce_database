...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 23, 2023 at 05:46 PM
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `gender`, `password`) VALUES
(1, 'ayomide', 'otusanya', 'aayomideotusanya@gmail.com', 'male', 'www'),
(2, 'ifeoluwa', 'timileyin', 'favsh@gmail.com', 'male', 'are'),
...
--
ALTER TABLE `cart_tb`
  MODIFY `user_id` int(222) NOT NULL AUTO_INCREMENT;
